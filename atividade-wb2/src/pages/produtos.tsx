                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>0</td>
                                <td>$0.00</td>
                            <td><Link to={'/produtos/Editar'}><button className="Botao3" >Editar</button></Link><button className="Botao3" onClick={()=>alert('Deletado com sucesso')}>Deletar</button></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>0</td>
                                <td>$0.00</td>
                                <td><Link to={'/produtos/Editar'}><button className="Botao3" >Editar</button></Link><button  className="Botao3" >Deletar</button></td>
                            </tr>
                        </tbody>
                    </table>
